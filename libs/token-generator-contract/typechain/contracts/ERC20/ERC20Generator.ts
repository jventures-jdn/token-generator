...
export declare namespace ERC20Generator {
...
export interface ERC20GeneratorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC20Generator extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Generator;
  waitForDeployment(): Promise<this>;

  interface: ERC20GeneratorInterface;
